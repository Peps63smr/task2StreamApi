...
public class Main {
    public static void main(String[] args) {
        ...
        long count = persons.stream()
                ...
                .count();
        System.out.println("Колличество несовершенолетних: " + count);

        List<String> army = persons.stream()
                .filter(person -> person.getAge() > 18 && person.getAge() <= 27 && person.getSex() == Sex.MAN)
                .map(Person::getFamily)
                .collect(Collectors.toList());
        System.out.println("Список фамилий призывников: " + army.subList(0, 5));
        ...
        List<Person> works = persons.stream()
                ...
                .collect(Collectors.toList());
        System.out.println("Список потенциально работоспособных людей с высшим образованием: " + works.subList(0, 5));
    }
}